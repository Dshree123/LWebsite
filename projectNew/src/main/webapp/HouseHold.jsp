...
<body>
  ...
  <div class="container-fluid" id="body" style="margin-top: 100px; margin-left: -3px;">
    <br>
    <div class="content">

      <h1>HOUSEHOLDS SECTION</h1>
        ...
        <table class="table table-hover br">
          <thead>
            <tr>
              ...
              <th scope="col-sm-4">Prize/kg</th>
              <th scope="col-sm-4"> Quantity</th>
              <th scope="col-sm-4">Add to Cart</th>
          ...
          <tbody>
            <tr>
              ...
              <td>200-300</td>
              <td><input type="email" class="form-control" id="exampleFormControlInput1" placeholder="qty in kg"></td>
              <td><button type="button" class="btn " style="background-color: #69ae14; margin-top: 5px;">Add to cart</button></td>
            <tr>
      ...
      <button type="button" class="btn  p-2"
        style="padding: 10px 30px 10px 30px; font-size: 20px; border: 1px solid #69ae14;"><a href="cart.html">Go to
          cart</a> </button>
      <button type="button" class="btn  p-2"
        style="padding: 10px 30px 10px 30px; font-size: 20px; margin-left: 20px;  border: 1px solid #69ae14;""> <a href="Servicejsp.jsp">Continue
          Booking</a></button>
    </div>
    <br>
  </div>
          ...
          <div class="row ">
            ...
            <div class="col-lg-3">
              <div class="footer-pad ">
                <h2>SERVICES</h2>
                <ol>
                  <li><a href="services.html">Dry cleaning Service</a></li>
                  <li> <a href="services.html">Iron Service</a></li>
                  <li> <a href="services.html">Starching Service</a></li>
                  <li><a href="services.html">Wahing Service</a></li>
