    ...
    <div class="content">
        ...
        <table class="table table-hover br">
          ...
          <tbody>
            <tr>
              ...
              <td><button type="button" class="btn " style="background-color: #69ae14; margin-top: 5px;">Add to
                  cart</button></td>
            <tr>
      ...
      <button type="button" class="btn  p-2"
        style="padding: 10px 30px 10px 30px; font-size: 20px; border: 1px solid #69ae14;"><a href="cart.html">Go to
          cart</a> </button>
      <button type="button" class="btn  p-2"
        style="padding: 10px 30px 10px 30px; font-size: 20px; margin-left: 20px;  border: 1px solid #69ae14;""> <a href="
        Servicejsp.jsp">Continue
        Booking</a></button>
    </div>
    <br>
  </div>
