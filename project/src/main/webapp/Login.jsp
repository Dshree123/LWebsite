			...
			<section class="col-12 col-sm-6 col-md-4">
				<form class="form-container" >
					...
					<div class="form-group">
						<h4 class="text-center font-weight-bold" style="font-size: 30px;">
							Login</h4>
						<label for="InputEmail1" style="font-size: 20px;">Email
							Address</label> <input type="email"   name="email" class="form-control" id="InputEmail1"
							aria-describeby="emailHelp" placeholder="Enter email">
					</div>
					<div class="form-group">
					...
					<button type="submit" class="btn btn-primary btn-block"
						style="font-size: 15px; padding: 5px; margin: 0, 0, 10px, 10px">Submit</button>
							...
							<div class="col-lg-3">
								<div class="footer-pad ">
									...
									<ul class="social-network social-circle">
										...
										<li><a href="suprabhatmm@gmail.com" class="icoenvelope"
