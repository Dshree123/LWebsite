  ...
  <div class="container-fluid   " style="background-color: rgb(119, 193, 218);">
    <div class="testimonial pro-content">
      <div class="testimonial4_slide">
        <h1 class="text-center p-2 " style="font-size:30px">HOW IT WORKS?
        </h1>

        <div class="row ">
          <div class="col-sm-4 ">
            <img src="images/step1-icon.png" id=img1>
            <h4 class="mb-2 mt-2">STEP 1. BOOK SERVICE </h4>
            <p class="mb-0 text-center mt-3">Click on Book Now button, type in your address and contact details and we'll be
              there.</p>
          </div>
          <div class="col-sm-4">
            <img src="images/step2-icon.png" id=img1>
            <h4 class="mb- mt-2"> STEP 2. WE DO THE JOB</h4>
            <p class="mb-0 text-center mt-3">We wash, iron and dry clean your clothes. Your clothes will be delivered to you
              in 2-3 days.</p>
          </div>
          <div class="col-sm-4">

            <img src="images/step3-icon.png" id=img1>
            <h4 class="mb-0 text-center mt-2" >STEP 3. YOU PAY FOR JOB </h4>
            <p class="mb-0 text-center mt-3">Once your order is delivered, you can pay your bill by cash, cheque or any cards
              or online.
            </p>
        ...
        <div class="col-md-6  ">
          ...
          <div class="pro-content ">
            <p>Thanks for your interest in Super Laundry ! We are Online Dry Cleaners & Laundry Service provider in
              India. We have worked hard to create a consistent and seamless clothing care experience with free pick up
              and drop offs. Our services include Dry Cleaning & Laundry service. We look forward to taking care of you
              soon!
            </p>
            <a class="btn  mt-3" href="services.html">More services</a>
          </div>
        </div>
        <div class="col-md-6  ">
          <img src="images/ezgif.com-gif-maker.png" class="img-fluid w-75 ">
        </div>
      </div>
    </div>
  </div>
...
<!--reason to choose us-->
  <div class="container-fluid   " style="background-color: rgb(119, 193, 218);">
    <div class="testimonial">
      ...
      <div class="text-center p-2 mt-4">
        <h4 class="text-center mt-4" style="font-size:30px">Delivering Clean Clothes and Peace of Mind
        </h4>
      ...
      <div class="testimonial4_slide">
        <div class="row mt-4">
          <div class="col-sm-4">
            ...
            <img src="images/home.jpeg" class="img-circle  " alt="" />
            <h4 class="mb-0">Professional Care </h4>

            <p>We are a supreme, door-to-door delivery dry cleaning and laundry service. With minimum effort you choose a
              pick-up & drop-off time and we all do work for you.</p>
          </div>
          <div class="col-sm-4">
            <img src="images/fast delivery.jpg" class="img-circle " />
            <h4 class="mb-0"> Fast Delivery</h4>
            <p>Laundry Spin dry cleaning and laundry, delivering your clean clothes 48hrs after pick-up. By the time you
              take off that last shirt, the fresh has arrived.</p>
          </div>
          <div class="col-sm-4">
            <img src="images/exce.jpg" class="img-circle  " />
            <h4 class="mb-0">Excellent Results </h4>

            <p>We provide high quality washing, dry cleaning and ironing services from premium facilities, and take
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-6">
        <img src="images/Home-Delivering.webp" class="img-fluid  ">
      </div>
      <div class="col-sm-6">
